...
namespace Part1 {
    public class Products {
        ...
        public Products () { }
        public Products (string name, decimal price,int supplierid) {
            _name = name;
            _price = price;
        ...
        public static List<Products> GetSmallProducts () {
            List<Products> list = new List<Products> {
                new Products (name: "one", price : 1.1m,supplierid:1),
                new Products (name: "two", price : 2.2m,supplierid:2),
                new Products (name: "three", price : 3.3m,supplierid:3)
            };
            return list;
        }
    ...
    public class Supplier {
        ...
        public Supplier (int supplierid, string name, decimal price) {
            SupplierID = supplierid;
            Name = name;
            Price = price;
        }
        public static List<Supplier> GetSmallSupplier()
        {
            return new List<Supplier>{
                new Supplier(supplierid:1,name:"a",price:1.1m),
                new Supplier(supplierid:2,name:"b",price:2.2m),
                new Supplier(supplierid:2,name:"c",price:3.3m)
            };
